...
<div class="tx-center mg-b-20"></div>
 ...
 <form method="POST" action="{{ route('register') }}">
        ...
        <!-- amount -->
        <div class="form-group">
            <x-input-label for="phone" :value="__('Amount')" />
            <x-text-input id="amount" class="form-control"  type="number" name="amount" :value="old('amount')" required autocomplete="amount" />
